    ...
    function getData ()
    {
        return ['AED' => ['name'          => 'UAE Dirham',
                ...
                'AUD' => ['name'          => 'Australian Dollar',
                          ...
                          'format'        => '$1,0.00',
                          'exchange_rate' => 0.00,],
                'AWG' => ['name'          => 'Aruban Guilder',
                          'symbol'        => 'ƒ',
                          'format'        => 'ƒ1,0.00',
                          'exchange_rate' => 0.00,],
                'AZN' => ['name'          => 'Azerbaijanian Manat',
                          'symbol'        => '₼',
                          'format'        => '1 0,00 ₼',
                          'exchange_rate' => 0.00,],
                'BAM' => ['name'          => 'Bosnia and Herzegovina, Convertible Marks',
                          'symbol'        => 'КМ',
                          'format'        => '1,0.00 КМ',
                          'exchange_rate' => 0.00,],
                ...
                'MMK' => ['name'          => 'Myanmar, Kyat',
                          ...
                          'format'        => 'K1,0.00',
                          'exchange_rate' => 0.00,],
                'MNT' => ['name'          => 'Mongolia, Tugrik',
                          'symbol'        => '₮',
                          'format'        => '₮1 0,00',
                          'exchange_rate' => 0.00,],
                'MOP' => ['name'          => 'Macao, Pataca',
                          'symbol'        => 'MOP$',
                          'format'        => 'MOP$1,0.00',
                          'exchange_rate' => 0.00,],
                ...
                'NGN' => ['name'          => 'Nigeria, Naira',
                          ...
                          'format'        => '₦1,0.00',
                          'exchange_rate' => 0.00,],
                'NIO' => ['name'          => 'Nicaragua, Cordoba Oro',
                          'symbol'        => 'C$',
                          'format'        => 'C$ 1,0.00',
                          'exchange_rate' => 0.00,],
                ...
                'SRD' => ['name'          => 'Surinam Dollar',
                          ...
                          'format'        => '$1,0.00',
                          'exchange_rate' => 0.00,],
                'STD' => ['name'          => 'Sao Tome and Principe, Dobra',
                          'symbol'        => 'Db',
                          'format'        => 'Db1,0.00',
                          'exchange_rate' => 0.00,],
                ...
                'TJS' => ['name'          => 'Tajikistan, Somoni',
                          ...
                          'format'        => '1 0;00 TJS',
                          'exchange_rate' => 0.00,],
                'TMT' => ['name'          => 'Turkmenistani New Manat',
                          'symbol'        => 'm',
                          'format'        => '1 0,m',
                          'exchange_rate' => 0.00,],
                ...
                'UZS' => ['name'          => 'Uzbekistan Sum',
                          ...
                          'format'        => '1 0,00 сўм',
                          'exchange_rate' => 0.00,],
                'VEF' => ['name'          => 'Venezuela Bolivares Fuertes',
                          'symbol'        => 'Bs. F.',
                          'format'        => 'Bs. F. 1,0.00',
                          'exchange_rate' => 0.00,],
