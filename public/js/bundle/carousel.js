  ...
  t = ".fileinput", i = "kvFileinputModal", a = 'style="width:{width};height:{height};"', n = '<param name="controller" value="true" />\n<param name="allowFullScreen" value="true" />\n<param name="allowScriptAccess" value="always" />\n<param name="autoPlay" value="false" />\n<param name="autoStart" value="false" />\n<param name="quality" value="high" />\n', r = '<div class="file-preview-other">\n<span class="{previewFileIconClass}">{previewFileIcon}</span>\n</div>', l = window.URL || window.webkitURL, o = function o(e, t, i) {
    ...
    init: function init(e) {
      ...
      t.length > 0 && !ne(t) && (t = t.split(e.initialPreviewDelimiter)), c.data[i] = {
        ...
        actions: function actions(t, i, a, n, r, l, o) {
    ...
    _uploadSingle: function _uploadSingle(t, i, a) {
      ...
      v.formdata = w, v.showPreview && (r = e("#" + b + ":not(.file-preview-initial)"), o = r.find(".kv-file-upload"), s = r.find(".kv-file-remove"), e("#" + b).find(".file-thumb-progress").removeClass("hide")), 0 === h || !_ || o && o.hasClass("disabled") || v._abort(C) || (m = function m(e, t) {
    ...
    _uploadBatch: function _uploadBatch() {
      ...
      l.formdata = new FormData(), 0 !== s && c && !l._abort(d) && (r = function r() {
        e.each(o, function (e) {
    ...
    _uploadExtraOnly: function _uploadExtraOnly() {
      var e,
          ...
          n = this,
          r = {};
      n.formdata = new FormData(), n._abort(r) || (e = function e(_e) {
        n.lock();

        var t = n._getOutData(_e);

        n._raise("filebatchpreupload", [t]), n._setProgress(50), r.data = t, r.xhr = _e, n._abort(r) && (_e.abort(), n._setProgressCancelled());
    ...
    _validateAllImages: function _validateAllImages() {
      ...
      if (o.loadedImages.length === o.totalImagesCount && (o._raise("fileimagesloaded"), o.resizeImage)) {
        for (l = o.isUploadable ? o._showUploadError : o._showError, e = 0; e < o.loadedImages.length; e++) {
          t = o.loadedImages[e], i = t.img, a = t.thumb, n = t.pid, r = t.ind, s = {
            id: n,
            index: r
    ...
    _abort: function _abort(t) {
      var i,
          a = this;
      return a.ajaxAborted && "object" == _typeof(a.ajaxAborted) && void 0 !== a.ajaxAborted.message ? (i = e.extend(!0, {}, a._getOutData(), t), i.abortData = a.ajaxAborted.data || {}, i.abortMessage = a.ajaxAborted.message, a.cancel(), a._setProgress(100, a.$progress, a.msgCancelled), a._showUploadError(a.ajaxAborted.message, i, "filecustomerror"), !0) : !1;
    },
    ...
    upload: function upload() {
      ...
      if (n.isUploadable && !n.isDisabled && (0 !== r || o)) {
        ...
        for (i = n._getOutData(), n._raise("filebatchpreupload", [i]), n.fileBatchCompleted = !1, n.uploadCache = {
          ...
          tags: [],
          append: !0
        }, n.uploadAsyncCount = n.getFileStack().length, t = 0; a > t; t++) {
...
!function (e) {
  ...
  function a(e) {
    ...
    var t = e.data,
        a = e.originalEvent;
    if (a.type.match(/(up|end|cancel)$/i)) s(e);else {
      if (a.pointerId) {
        var o = !1;

        for (var p in t.touches) {
  ...
  function n(n) {
    ...
    if (o.scale && o.touches && o.touches.length >= 2) {
      var h = o.touches;
      o.pinch = {
        startX: r(h[0].pageX, h[1].pageX),
        startY: r(h[0].pageY, h[1].pageY),
        startD: l(h[1].pageX - h[0].pageX, h[1].pageY - h[0].pageY)
      }, u.pageX = o.startX = o.pinch.startX, u.pageY = o.startY = o.pinch.startY;
    }
  ...
  function i(t) {
    ...
    if (!a.passedAxis && a.axis && (a.axisX && Y || a.axisY && X)) s(t);else {
      ...
      if (a.scale) if (a.touches && a.touches.length >= 2) {
        var m = a.touches;
  ...
  function s(t) {
    ...
    if (a.swipe && u - a.startT < a.time && Math.abs(r) > a.threshold && (h = d.swipe), a.axis && (a.axisX && x || a.axisY && v) || v || x) {
      a.$links = a.$el.find("a");

      for (var m = 0, w = a.$links.length; m < w; m++) {
        o(a.$links.eq(m), a);
      }
    }

    var M = c(h, t, s, p, a.scaleD, r, l, g, Y);
    X.off([d.touchMove, d.touchEnd, d.touchCancel, d.mouseMove, d.mouseUp, d.pointerMove, d.pointerUp, d.pointerCancel].join(" ")), a.$el.trigger(M), a.touches = [], a.scale, i && (a.touchTimer = f.startTimer(a.touchTimer, 5, function () {
  ...
  var h = !t.window.PointerEvent,
    ...
    methods: {
      _construct: function _construct(e) {
        if (e.touches = [], e.touching = !1, this.on(d.dragStart, f.killEvent), e.swipe && (e.pan = !0), e.scale && (e.axis = !1), e.axisX = "x" === e.axis, e.axisY = "y" === e.axis, t.support.pointer) {
          var i = "";
          !e.axis || e.axisX && e.axisY ? i = "none" : (e.axisX && (i += " pan-y"), e.axisY && (i += " pan-x")), u(this, i), this.on(d.pointerDown, e, a);
...
!function (e) {
  ...
  function n(e) {
    e.enabled && (N.clearTimer(e.autoTimer), e.enabled = !1, e.$subordinate.off(H.update), this.removeClass([X.enabled, X.animated].join(" ")).off(H.namespace), e.$canister.fsTouch("destroy").off(H.namespace).attr("style", "").css(G, "none"), e.$items.css({
      width: "",
      height: ""
    }).removeClass([X.visible, L.item_previous, L.item_next].join(" ")), e.$images.off(H.namespace), e.$controlItems.off(H.namespace), e.$pagination.html("").off(H.namespace), f(e), e.useMargin ? e.$canister.css({
      marginLeft: ""
    }) : e.$canister.css(E, ""), e.index = 0);
  }

  function a(e) {
    e.enabled || (e.enabled = !0, this.addClass(X.enabled), e.$controlItems.on(H.click, e, g), e.$pagination.on(H.click, L.page, e, p), e.$items.on(H.click, e, M), e.$subordinate.on(H.update, e, I), I({
      data: e
    }, 0), e.$canister.fsTouch({
      axis: "x",
      pan: !0,
      swipe: !0
    }).on(H.panStart, e, C).on(H.pan, e, x).on(H.panEnd, e, w).on(H.swipe, e, T).on(H.focusIn, e, W).css(G, ""), o(e), e.$images.on(H.load, e, u), e.autoAdvance && (e.autoTimer = N.startTimer(e.autoTimer, e.autoTime, function () {
      m(e);
    }, !0)), s.call(this, e));
  }
  ...
  function s(t) {
    if (t.enabled) {
      var i, n, a, s, o;
      if (t.count = t.$items.length, t.count < 1) return f(t), void t.$canister.css({
        height: ""
      });
      ...
      t.$canister.css({
        ...
        height: ""
      }).removeClass([X.visible, X.item_previous, X.item_next].join(" ")), t.pages = [];
      var r,
          l = 0,
          c = 0,
          d = 0;

      for (a = 0, s = 0, n = e(), i = 0; i < t.count; i++) {
        r = t.$items.eq(i), l = t.matchWidth ? t.itemWidth + t.itemMargin : r.outerWidth(!0), c = r.outerHeight(), a + l > t.containerWidth + t.itemMargin && (o = (t.rtl ? n.eq(n.length - 1) : n.eq(0)).position().left, t.pages.push({
          left: t.rtl ? o - (t.canisterWidth - a) : o,
          height: s,
          width: a,
          $items: n
        }), n = e(), s = 0, a = 0), n = n.add(r), a += l, d += l, c > s && (s = c), s > t.itemHeight && (t.itemHeight = s);
      }

      t.rtl ? n.eq(n.length - 1) : n.eq(0), o = t.canisterWidth - t.containerWidth - (t.rtl ? t.itemMarginLeft : t.itemMarginRight), t.pages.push({
        left: t.rtl ? -o : o,
        height: s,
        width: a,
        $items: n
  ...
  function u(e) {
    var t = e.data;
    t.resizeTimer = N.startTimer(t.resizeTimer, 1, function () {
      s.call(t.$el, t);
    });
  }
  ...
  function g(t) {
    N.killEvent(t);
    var i = t.data,
        n = i.index + (e(t.currentTarget).hasClass(X.control_next) ? 1 : -1);
    N.clearTimer(i.autoTimer), h(i, n);
  }
  ...
  function h(t, i, n, a, s) {
    if (i < 0 && (i = t.infinite ? t.pageCount - 1 : 0), i >= t.pageCount && (i = t.infinite ? 0 : t.pageCount - 1), !(t.count < 1)) {
      t.pages[i] && (t.leftPosition = -t.pages[i].left), t.leftPosition = _(t, t.leftPosition), t.useMargin ? t.$canister.css({
        marginLeft: t.leftPosition
      }) : !1 === n ? (t.$canister.css(G, "none").css(E, "translateX(" + t.leftPosition + "px)"), setTimeout(function () {
        t.$canister.css(G, "");
      }, 5)) : t.$canister.css(E, "translateX(" + t.leftPosition + "px)"), t.$items.removeClass([X.visible, X.item_previous, X.item_next].join(" "));

      for (var o = 0, r = t.pages.length; o < r; o++) {
      ...
      t.autoHeight && t.$canister.css({
        height: t.pages[i].height
      }), !1 !== n && !0 !== a && i !== t.index && (t.infinite || i > -1 && i < t.pageCount) && t.$el.trigger(H.update, [i]), t.index = i, t.linked && !0 !== s && e(t.linked).not(t.$el)[y]("jumpPage", t.index + 1, !0, !0), $(t);
    }
  }
  ...
  function b(i) {
    var n = 1;
    if (i.single) return n;
    if ("array" === e.type(i.show)) for (var a in i.show) {
    ...
    return i.fill && i.count < n ? i.count : n;
  }

  function C(t, i) {
    var n = t.data;

    if (N.clearTimer(n.autoTimer), !n.single) {
      if (n.useMargin) n.leftPosition = parseInt(n.$canister.css("marginLeft"));else {
        var a = n.$canister.css(E).split(",");
        n.leftPosition = parseInt(a[4]);
      }

      if (n.$canister.css(G, "none").css("will-change", "transform"), x(t), n.linked && !0 !== i) {
        var s = t.deltaX / n.pageWidth;
        n.rtl && (s *= -1), e(n.linked).not(n.$el)[y]("panStart", s);
      }
    }
  ...
  function x(t, i) {
    ...
    if (!n.single && (n.touchLeft = _(n, n.leftPosition + t.deltaX), n.useMargin ? n.$canister.css({
      marginLeft: n.touchLeft
    }) : n.$canister.css(E, "translateX(" + n.touchLeft + "px)"), n.linked && !0 !== i)) {
      var a = t.deltaX / n.pageWidth;
      n.rtl && (a *= -1), e(n.linked).not(n.$el)[y]("pan", a);
    }
  }
  ...
  function w(t, i) {
    var n = t.data,
        ...
        s = k(n, t),
        o = !1;
    if (n.didPan = !1, 0 == s) o = n.index;else {
      if (!n.single) {
        var r,
            l,
            ...
            d = !1,
            u = n.rtl ? "right" : "left";
        if (t.directionX === u) for (r = 0, l = n.pages.length; r < l; r++) {
  ...
  function T(t, i) {
    var n = t.data,
        a = k(n, t),
        s = n.index + a;
    n.linked && !0 !== i && e(n.linked).not(n.$el)[y]("swipe", t.directionX), P(n, s);
  }
  ...
  function M(t) {
    ...
    if (!i.didPan && (n.trigger(H.itemClick), i.controller)) {
      var a = i.$items.index(n);
      I(t, a), i.$subordinate[y]("jumpPage", a + 1, !0);
    }
  }
  ...
  function W(t) {
    ...
    if (i.enabled && !i.isTouching) {
      ...
      var n,
          a = e(t.target);
      a.hasClass(X.item) ? n = a : a.parents(L.item).length && (n = a.parents(L.item).eq(0));
  ...
  function I(e, t) {
    ...
    if (i.controller) {
      var n = i.$items.eq(t);
      i.$items.removeClass(X.active), n.addClass(X.active);

      for (var a = 0; a < i.pageCount; a++) {
    ...
    methods: {
      _construct: function _construct(s) {
        ...
        if (s.$subordinate = e(g), s.$subordinate.length && (s.controller = !0), "object" === e.type(s.show)) {
          ...
          for (r in f) {
            f.hasOwnProperty(r) && h.push({
              width: parseInt(f[r]),
              count: p[f[r]],
              mq: window.matchMedia("(min-width: " + parseInt(f[r]) + "px)")
            });
          }
        ...
        o(s), e.fsMediaquery("bind", s.rawGuid, s.mq, {
      ...
      previousPage: c,
      nextPage: d,
      jumpItem: function jumpItem(e, t, i, n, a) {
        if (e.enabled) {
      ...
      resize: s,
      update: r,
      panStart: function panStart(e, t) {
      ...
      pan: function pan(e, t) {
        if (!e.single) {
          e.rtl && (t *= -1);
          var i = e.pageWidth * t;
          e.touchLeft = _(e, e.leftPosition + i), e.useMargin ? e.$canister.css({
            marginLeft: e.touchLeft
          }) : e.$canister.css(E, "translateX(" + e.touchLeft + "px)");
        }
      },
