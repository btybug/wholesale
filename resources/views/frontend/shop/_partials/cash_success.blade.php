            ...
            <div class="container main-max-width">
                <div class="shopping-cart-head">
                    <ul class="nav nav-pills">
                        ...
                        <li class="nav-item col-md-3">
                            <a class="item visited d-flex align-items-center justify-content-between" href="order-payment.html">
                        ...
                        <li class="nav-item col-md-3">
                            <a class="item active d-flex align-items-center justify-content-between" href="#">
