            ...
            <h2 class="m-0 pull-left">Settings</h2>
                    ...
                    <div class="card panel panel-default">
                        <div class="card-header panel-heading head-space-between">
                            <h2>{!! ucfirst(str_replace("_"," ",'posts')) !!} Category</h2>
...
@section('js')
    ...
    <script>
        ...
        $("body").on('click', '.add-category', function () {
            AjaxCall("/admin/tools/categories/get-form/posts", {id: null}, function (res) {
                if (!res.error) {
        ...
        $("#tree1").bind("tree.click", function (e) {
            AjaxCall("/admin/tools/categories/get-form/posts", {id: e.node.id}, function (res) {
                if (!res.error) {
                    $(".category-form-place").html(res.html);
                    $('.icon-picker').iconpicker();
                    $("#select-stickers").select2();
