            ...
            <div class="row">
                <div class="col-md-4 col-sm-2">
                    <div class="modal_left-img-holder h-100"
                         style="background-image: url(/public/img/temp/modal-login-bg.jpg)"></div>
                </div>
                ...
                <div class="col-md-8 col-sm-10">
                    <div class="modal_right d-flex flex-column justify-content-between h-100">
                        <div>
                            ...
                            <p class="font-13 text-gray-clr modal-text"> Lorem Ipsum is simply dummy text of the
                                ...
                                <div class="col-md-6 d-flex align-items-center">
                                    <div class="position-relative">
                                        <input class="form-check-input register-form_input-check" type="checkbox"
                                               value="" id="rememberCheck1" name="remember">
  ...
  <path
      d="m.3,14c-0.2-0.2-0.3-0.5-0.3-0.7s0.1-0.5 0.3-0.7l1.4-1.4c0.4-0.4 1-0.4 1.4,0l.1,.1 5.5,5.9c0.2,0.2 0.5,0.2 0.7,0l13.4-13.9h0.1v-8.88178e-16c0.4-0.4 1-0.4 1.4,0l1.4,1.4c0.4,0.4 0.4,1 0,1.4l0,0-16,16.6c-0.2,0.2-0.4,0.3-0.7,0.3-0.3,0-0.5-0.1-0.7-0.3l-7.8-8.4-.2-.3z"/>
                                ...
                                <div class="col-md-6 text-right modal-accounts_btn-holder">
                                    <button type="button" class="btn text-uppercase btn-submit font-15 sign_in">Sign
                                        in
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <a href="{{ route('password.request') }}" class="font-13 text-gray-clr text-uderlined">Forgot
                                    Password?</a>
                            </div>
                            <div class="col-md-6 text-right ">
                                <p class="mb-0 font-13 text-gray-clr">
                                    Don't have an account?&nbsp;
                                    <span class="text-uderlined text-uppercase text-main-clr pointer"
